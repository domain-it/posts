...
function appHasPeriodicNotesPluginLoaded() {
  ...
  return (
    ...
    ((
      (_b =
        (_a = periodicNotes.settings) === null || _a === void 0 ?
          void 0
        : _a.weekly) === null || _b === void 0
    ) ?
      void 0
    : _b.enabled)
  );
...
class CalendarSettingsTab extends obsidian.PluginSettingTab {
  ...
  addLocaleOverrideSetting() {
    ...
    const { moment } = window;
    const sysLocale =
      (_a = navigator.language) === null || _a === void 0 ?
        void 0
      : _a.toLowerCase();
    new obsidian.Setting(this.containerEl)
...
function add_css$2() {
  ...
  style.textContent =
    '.nav.svelte-1vwr9dd.svelte-1vwr9dd{align-items:center;display:flex;margin:0.6em 0 1em;padding:0 8px;width:100%}.nav.is-mobile.svelte-1vwr9dd.svelte-1vwr9dd{padding:0}.title.svelte-1vwr9dd.svelte-1vwr9dd{color:var(--color-text-title);settings-menu:1.5em;margin:0}.is-mobile.svelte-1vwr9dd .title.svelte-1vwr9dd{settings-menu:1.3em}.month.svelte-1vwr9dd.svelte-1vwr9dd{font-weight:500;text-transform:capitalize}.year.svelte-1vwr9dd.svelte-1vwr9dd{color:var(--interactive-accent)}.right-nav.svelte-1vwr9dd.svelte-1vwr9dd{display:flex;justify-content:center;margin-left:auto}.reset-button.svelte-1vwr9dd.svelte-1vwr9dd{cursor:pointer;border-radius:4px;color:var(--text-muted);settings-menu:0.7em;font-weight:600;letter-spacing:1px;margin:0 4px;padding:0px 4px;text-transform:uppercase}.is-mobile.svelte-1vwr9dd .reset-button.svelte-1vwr9dd{display:none}';
  append(document.head, style);
}
...
function add_css$1() {
  ...
  style.textContent =
    'td.svelte-egt0yd{border-right:1px solid var(--background-modifier-border)}.week-num.svelte-egt0yd{background-color:var(--color-background-weeknum);border-radius:4px;color:var(--color-text-weeknum);cursor:pointer;settings-menu:0.65em;height:100%;padding:4px;text-align:center;transition:background-color 0.1s ease-in, color 0.1s ease-in;vertical-align:baseline}.week-num.svelte-egt0yd:hover{background-color:var(--interactive-hover)}.week-num.active.svelte-egt0yd:hover{background-color:var(--interactive-accent-hover)}.active.svelte-egt0yd{color:var(--text-on-accent);background-color:var(--interactive-accent)}.dot-container.svelte-egt0yd{display:flex;flex-wrap:wrap;justify-content:center;line-height:6px;min-height:6px}';
  append(document.head, style);
}
...
function add_css() {
  ...
  style.textContent =
    '.container.svelte-pcimu8{--color-background-heading:transparent;--color-background-day:transparent;--color-background-weeknum:transparent;--color-background-weekend:transparent;--color-dot:var(--text-muted);--color-arrow:var(--text-muted);--color-button:var(--text-muted);--color-text-title:var(--text-normal);--color-text-heading:var(--text-muted);--color-text-day:var(--text-normal);--color-text-today:var(--interactive-accent);--color-text-weeknum:var(--text-muted)}.container.svelte-pcimu8{padding:0 8px}.container.is-mobile.svelte-pcimu8{padding:0}th.svelte-pcimu8{text-align:center}.weekend.svelte-pcimu8{background-color:var(--color-background-weekend)}.calendar.svelte-pcimu8{border-collapse:collapse;width:100%}th.svelte-pcimu8{background-color:var(--color-background-heading);color:var(--color-text-heading);settings-menu:0.6em;letter-spacing:1px;padding:4px;text-transform:uppercase}';
  append(document.head, style);
}
...
function create_fragment(ctx) {
  ...
  binding_callbacks$1.push(() =>
    bind(calendarbase, 'displayedMonth', calendarbase_displayedMonth_binding)
  );
  ...
  return {
    ...
    p(ctx, [dirty]) {
      ...
      if (dirty & /*sources*/ 2)
        calendarbase_changes.sources = /*sources*/ ctx[1];
      if (dirty & /*today*/ 512) calendarbase_changes.today = /*today*/ ctx[9];
      if (dirty & /*onHoverDay*/ 4)
        calendarbase_changes.onHoverDay = /*onHoverDay*/ ctx[2];
      if (dirty & /*onHoverWeek*/ 8)
        calendarbase_changes.onHoverWeek = /*onHoverWeek*/ ctx[3];
      if (dirty & /*onContextMenuDay*/ 64)
        calendarbase_changes.onContextMenuDay = /*onContextMenuDay*/ ctx[6];
      if (dirty & /*onContextMenuWeek*/ 128)
        calendarbase_changes.onContextMenuWeek = /*onContextMenuWeek*/ ctx[7];
      if (dirty & /*onClickDay*/ 16)
        calendarbase_changes.onClickDay = /*onClickDay*/ ctx[4];
      if (dirty & /*onClickWeek*/ 32)
        calendarbase_changes.onClickWeek = /*onClickWeek*/ ctx[5];
      if (dirty & /*today*/ 512)
        calendarbase_changes.localeData = /*today*/ ctx[9].localeData();
      if (dirty & /*$activeFile*/ 1024)
        calendarbase_changes.selectedId = /*$activeFile*/ ctx[10];
      if (dirty & /*$settings*/ 256)
        calendarbase_changes.showWeekNums = /*$settings*/ ctx[8].showWeeklyNote;
...
function instance($$self, $$props, $$invalidate) {
  ...
  component_subscribe($$self, activeFile, $$value =>
    $$invalidate(10, ($activeFile = $$value))
  );
  ...
  $$self.$$set = $$props => {
    ...
    if ('onHoverWeek' in $$props)
      $$invalidate(3, (onHoverWeek = $$props.onHoverWeek));
    if ('onClickDay' in $$props)
      $$invalidate(4, (onClickDay = $$props.onClickDay));
    if ('onClickWeek' in $$props)
      $$invalidate(5, (onClickWeek = $$props.onClickWeek));
    if ('onContextMenuDay' in $$props)
      $$invalidate(6, (onContextMenuDay = $$props.onContextMenuDay));
    if ('onContextMenuWeek' in $$props)
      $$invalidate(7, (onContextMenuWeek = $$props.onContextMenuWeek));
  };
...
function getNoteTags(note) {
  ...
  const frontmatter =
    (_a = metadataCache.getFileCache(note)) === null || _a === void 0 ?
      void 0
    : _a.frontmatter;
  const tags = [];
  if (frontmatter) {
...
class CalendarView extends obsidian.ItemView {
  ...
  async onFileModified(file) {
    const date =
      getDateFromFile_1(file, 'day') || getDateFromFile_1(file, 'week');
...
class CalendarPlugin extends obsidian.Plugin {
  ...
  async writeOptions(changeOpts) {
    settings.update(old =>
      Object.assign(Object.assign({}, old), changeOpts(old))
    );
    await this.saveData(this.options);
  }
}
